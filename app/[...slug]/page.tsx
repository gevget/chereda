...
export function generateStaticParams(){
  const base=['feed','search','pro','ratings','collections','me','notifications','settings','about','demo','register','professional','recommendations','subscriptions','favorites-pro','platform','support','offline','blog','faq','knowledge','video-lessons','webinars','api','complaint'].map(slug=>({slug:[slug]}));

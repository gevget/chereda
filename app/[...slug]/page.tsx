...
export function generateStaticParams(){
  const base=['feed','search','brief','crew-match','requests','venue-fit','passport','partners','radar','credits','pro','ratings','collections','favorites','me','notifications','settings','about','demo','register','professional','recommendations','subscriptions','favorites-pro','platform','support','offline','blog','faq','knowledge','video-lessons','webinars','api','complaint','404','error'].map(slug=>({slug:[slug]}));

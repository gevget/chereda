...
export function generateStaticParams(){
  const base=['feed','search','pro','ratings','collections','me','notifications','settings','about','demo','register','professional'].map(slug=>({slug:[slug]}));
